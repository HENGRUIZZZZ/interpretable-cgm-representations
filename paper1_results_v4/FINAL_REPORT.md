...
- **按 SSPG_r + DI_r 之和** 选出的主 run：**SEED=21 LAMBDA_IR=0.05**，结果已复制到 `paper1_results/`。
- **SSPG 最优 run**（用于 si vs SSPG、Bland-Altman 图）：`run_s21_lam0.05` → SSPG r=0.652, RMSE=59.5.
- **DI 最优 run**（用于 mi vs DI 图）：`run_s21_lam0.05` → DI r=0.513, RMSE=1.0.
...
- **SSPG** 5 折 Spearman r：min=0.487, mean=0.652, max=0.784
- **DI** 5 折 Spearman r：min=0.203, mean=0.513, max=0.636
