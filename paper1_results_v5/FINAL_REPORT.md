...
- **按 SSPG_r + DI_r 之和** 选出的主 run：**SEED=21 LAMBDA_IR=0.1**，结果已复制到 `paper1_results/`。
- **SSPG 最优 run**（用于 si vs SSPG、Bland-Altman 图）：`run_s21_lam0.1` → SSPG r=0.444, RMSE=63.8.
- **DI 最优 run**（用于 mi vs DI 图）：`run_s21_lam0.1` → DI r=0.465, RMSE=1.0.
...
- **SSPG** 5 折 Spearman r：min=0.119, mean=0.444, max=0.666
- **DI** 5 折 Spearman r：min=0.357, mean=0.465, max=0.510
